...
class UserAppData(models.Model):
	...
	user	 				= models.OneToOneField(BaseAccount, related_name="appdata_user", on_delete=models.CASCADE)
...
class Interactions(models.Model):
	...
	user 					= models.OneToOneField(BaseAccount, related_name="interactions_user", on_delete=models.CASCADE)
